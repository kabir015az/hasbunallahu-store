...
function getDisplayStatus(databaseStatus) {
...
function getDatabaseStatus(displayStatus) {
    ...
    return statuses.map(
        displayStatus => {
            ...
            return `
                ...
                <option
                    value="${escapeHtml(displayStatus)}"
                    ${selected}
                >
...
async function saveOrderUpdate(
    ...
    try {
        ...
        if (!verifyOrder) {
            ...
            throw new Error(
                "Order was not found after updating."
            );
        ...
        if (
            ...
            throw new Error(
                "Database returned a different status.\n\n" +
                "Selected: " +
                displayStatus +
                "\n" +
                "Sent to database: " +
...
document.addEventListener(
    ...
    function() {
        ...
        console.log(
            "HASBUNALLAHU ADMIN JS - STATUS MAPPING VERSION"
        );
